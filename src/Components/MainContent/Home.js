        ...
        <>
                            ...
                            <div className="row">
                                    ...
                                    <div className="card info-card sales-card">
                                        ...
                                        <div className="filter">
                                            <Link className="icon" to="/" data-bs-toggle="dropdown"><i
                                                className="bi bi-three-dots"></i></Link>
                                            <ul
                                ...
                                <div className="col-xxl-4 col-md-6">
                                    <div className="card info-card revenue-card">
                                        ...
                                        <div className="card-body">
                                            <h5 className="card-title">Revenue <span>| This
                                                Month</span></h5>
                                ...
                                <div className="col-xxl-4 col-xl-12">
                                    ...
                                    <div className="card info-card customers-card">
                                        ...
                                        <div className="card-body">
                                            <h5 className="card-title">Customers <span>| This
                                                Year</span></h5>
                ...
                document.addEventListener("DOMContentLoaded", () => {
                                ...
                                <div className="col-12">
                                    <div className="card recent-sales overflow-auto">
                                        ...
                                        <div className="card-body">
                                            <h5 className="card-title">Recent Sales <span>|
                                                Today</span></h5>
                                            ...
                                            <table className="table table-borderless datatable">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>Brandon Jacob</td>
                                                        <td><a href="#" className="text-primary">At praesentium
                                                            minu</a></td>
                                                        <td>$64</td>
                                                        <td><span
                                                            className="badge bg-success">Approved</span></td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row"><a href="#">#2147</a></th>
                                                        <td>Bridie Kessler</td>
                                                        <td><a href="#" className="text-primary">Blanditiis dolor
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="#" className="text-primary">At recusandae
                                                            consectetur</a></td>
                                                        <td>$147</td>
                                                        <td><span
                                                            className="badge bg-success">Approved</span></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>Angus Grady</td>
                                                        <td><a href="#" className="text-primar">Ut voluptatem id
                                                            earum et</a></td>
                                                        <td>$67</td>
                                                    ...
                                                    <tr>
                                                        <th scope="row"><a href="#">#2644</a></th>
                                                        <td>Raheem Lehner</td>
                                                        <td><a href="#" className="text-primary">Sunt similique
                                                            distinctio</a></td>
                                                        <td>$165</td>
                                                        <td><span
                                                            className="badge bg-success">Approved</span></td>
                                            ...
                                            <table className="table table-borderless">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="#"
                                                            className="text-primary fw-bold">Exercitationem
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="#" className="text-primary fw-bold">Doloribus
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="#" className="text-primary fw-bold">Officiis
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="#" className="text-primary fw-bold">Sit unde
                        ...
                        <div className="col-lg-4">
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="activity">
                                        ...
                                        <div className="activity-item d-flex">
                                            ...
                                            <div className="activity-content">
                                                Quia quae rerum <a href="#"
                                                    className="fw-bold text-dark">explicabo officiis</a> beatae
                                            </div>
                                        </div>
                                        ...
                                        <div className="activity-item d-flex">
                                            ...
                                            <i
                                                className='bi bi-circle-fill activity-badge text-danger align-self-start'></i>
                                            <div className="activity-content">
                                        ...
                                        <div className="activity-item d-flex">
                                            ...
                                            <div className="activity-content">
                                                Tempore autem saepe <a href="#"
                                                    className="fw-bold text-dark">occaecati voluptatem</a>
                                                tempore
                                            </div>
                                        </div>
                                        ...
                                        <div className="activity-item d-flex">
                                            ...
                                            <i
                                                className='bi bi-circle-fill activity-badge text-warning align-self-start'></i>
                                            <div className="activity-content">
                                        ...
                                        <div className="activity-item d-flex">
                                            ...
                                            <i
                                                className='bi bi-circle-fill activity-badge text-muted align-self-start'></i>
                                            <div className="activity-content">
                            ...
                            <div className="card">
                                ...
                                <div className="card-body pb-0">
                                    <h5 className="card-title">Budget Report <span>| This
                                        Month</span></h5>

                                    <div id="budgetChart" style={{ minHeight: '400px' }} classNameName="echart"></div>
              ...
              var budgetChart = echarts.init(document.querySelector("#budgetChart")).setOption({
                            ...
                            <div className="card">
                                ...
                                <div className="card-body pb-0">
                                    ...
                                    <div id="trafficChart" style={{ minHeight: '400px' }} classNameName="echart"></div>
            ...
            document.addEventListener("DOMContentLoaded", () => {
                            ...
                            <div className="card">
                                ...
                                <div className="card-body pb-0">
                                    <h5 className="card-title">News &amp; Updates <span>|
                                        Today</span></h5>
                                    ...
                                    <div className="news">
                                        ...
                                        <div className="post-item clearfix">
                                            ...
                                            <h4><a href="#">Et dolores corrupti quae illo quod
                                                dolor</a></h4>
