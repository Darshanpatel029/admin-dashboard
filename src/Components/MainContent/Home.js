            ...
            <main id="main" class="main">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xxl-4 col-md-6">
                                    <div class="card info-card sales-card">
                                        ...
                                        <div class="filter">
                                            <Link class="icon" to="/" data-bs-toggle="dropdown"><i
                                                class="bi bi-three-dots"></i></Link>
                                            <ul
                                ...
                                <div class="col-xxl-4 col-md-6">
                                    <div class="card info-card revenue-card">
                                        ...
                                        <div class="card-body">
                                            <h5 class="card-title">Revenue <span>| This
                                                Month</span></h5>
                                ...
                                <div class="col-xxl-4 col-xl-12">
                                    ...
                                    <div class="card info-card customers-card">
                                        ...
                                        <div class="card-body">
                                            <h5 class="card-title">Customers <span>| This
                                                Year</span></h5>
                    ...
                    document.addEventListener("DOMContentLoaded", () => {
                                            ...
                                            <table class="table table-borderless">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="#"
                                                            class="text-primary fw-bold">Exercitationem
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body pb-0">
                                    <h5 class="card-title">Budget Report <span>| This
                                        Month</span></h5>
                ...
                document.addEventListener("DOMContentLoaded", () => {
                            ...
                            <div class="card">
                                ...
                                <div class="card-body pb-0">
                                    <h5 class="card-title">News &amp; Updates <span>|
                                        Today</span></h5>
