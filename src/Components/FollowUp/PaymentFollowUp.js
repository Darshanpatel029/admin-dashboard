...
const PaymentFollowUp = (props) => {
    ...
    const handleSubmit = async (e) => {
        ...
        formDataToSend.append("attachment_PaymentFollowup", FollowUpData.attachment_PaymentFollowup);

        Object.keys(formData).forEach((key) => {
            if (key !== "attachment_PaymentFollowup" && key !== "reminder_date" && key !== "reminder_time") {
                                            ...
                                            <div className="row mb-2">
                                                ...
                                                <div className="col-md-5">
                                                    <input
                                                        ...
                                                        type="file"
                                                        id="formFile"
                                                        name="attachment_PaymentFollowup"
                                                        onChange={handleChange}
                                                    />
                                                </div>
                                            </div>
